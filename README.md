...
[![Versão](https://img.shields.io/badge/versão-2.6.0-F56E2E?style=flat-square)](https://bloquin.online)
...
1. Acesse [bloquin.online](https://bloquin.online) ou baixe a versão estável diretamente:
   ...
   | --- | --- | --- | --- |
   | Windows 10/11 (64-bit) | **[↓ BloquinIDE_2.6.0.exe](https://github.com/FelipeSilva10/Bloquin/releases/latest/download/BloquinIDE_2.6.0.exe)** | 22,2 MB | ✅ Disponível |
